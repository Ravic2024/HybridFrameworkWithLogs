...
public class TakeICCDepartment extends TestBase {
	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")
	public void ICCDepartment(String Subject, String Dept, String Location, String Team, String TType, String Service,
			String ADDREMOVEFrom, String description) throws Throwable {
		// clicking create icon
...
//		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("SearchBox_XPATH"))));
		...
		// TType
		waitForElement("TType_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("TType_XPATH"))));
		Click("TType_XPATH");
		waitForElement("SearchBox_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("SearchBox_XPATH"))));
		...
		// Service
		waitForElement("Service_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("Service_XPATH"))));
		Click("Service_XPATH");
		waitForElement("SearchBox_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("SearchBox_XPATH"))));
		searchBoxDropDown("SearchBox_XPATH", Service);

		// ADD/REMOVE
		waitForElement("ADD/REMOVE_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("ADD/REMOVE_XPATH"))));
		Click("ADD/REMOVE_XPATH");
		waitForElement("SearchBox_XPATH");
		Assert.assertTrue(isElementPresent(By.xpath(OR.getProperty("SearchBox_XPATH"))));
		searchBoxDropDown("SearchBox_XPATH", ADDREMOVEFrom);
