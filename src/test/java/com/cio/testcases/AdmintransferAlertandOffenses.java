...
public class AdmintransferAlertandOffenses extends TestBase {

	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")

	public void AlertandOffensestransfer(String Subject, String department, String location, String Team,
			String tickettype, String Admcat, String Description, String TransferDept, String TransferLoc)
			throws Throwable {
		...
		try {
			...
			waitForElement("TicketViewStar_XPATH");
			String TransferredDept = driver.findElement(By.xpath(OR.getProperty("DisabledDeptDDown"))).getText();
			...
			String TransferredLoc = driver.findElement(By.xpath(OR.getProperty("DisabledLocDDown"))).getText();
