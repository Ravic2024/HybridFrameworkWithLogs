...
public class AssignIT extends TestBase {

	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")

	public void ITAssign(String Subject, String department, String location, String modeofwork, String ITcatDropdown,
			String Building, String BusinessUnit, String Workstation, String Description, String AssignRole,
		...
		try {
			...
			Click("ITCat_XPATH");
			selectEmailAddress("Searchbox_XPATH", ITcatDropdown);
