...
public class TicketAdmin extends TestBase {

	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")
	public void AdminTicket(String Subject) {
		try {
	...
	@Test(dataProviderClass = TestUtils.class, dataProvider = "dp")
	public void AdminTicketfields(String department, String location, String Team, String tickettype, String Admcat,
			String Description, String Subject) throws Throwable {
